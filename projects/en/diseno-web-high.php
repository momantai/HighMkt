<div class="ajax-container">
			...
			<div class="row">
				<div class="col-md-12 align-self-center p-static order-2 text-center">
					<div class="overflow-hidden pb-2">
						<h2 class="text-dark font-weight-bold text-7 mb-0">High Marketing</h2>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row pb-4 mb-2">
		...
		<div class="col-sm-6">
			<h2 class="text-color-dark font-weight-normal text-4 mb-0">Project <strong class="font-weight-extra-bold">High Marketing</strong></h2>
			<p>Development of the HighMarketing website.</p>
			...
			<ul class="list list-icons list-primary list-borders text-2">
				<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Client:</strong> PDI Companies</li>
				...
				<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Project URL:</strong> <a href="http://www.highmktstudio.com/" target="_blank" class="text-dark">http://www.highmktstudio.com/</a></li>
			</ul>
		</div>
	</div>
</div>
